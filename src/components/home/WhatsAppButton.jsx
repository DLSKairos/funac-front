...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-funac-green rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-transform"
    >
